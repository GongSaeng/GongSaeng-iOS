...
final class LocalePopUp2ViewController: UIViewController {

    // MARK: Properties
    private var viewModel: Locale2ViewModel
    ...
    // MARK: Lifecycle
    init(viewModel: Locale2ViewModel) {
...
extension LocalePopUp2ViewController: UITableViewDataSource {
...
extension LocalePopUp2ViewController: UITableViewDelegate {
